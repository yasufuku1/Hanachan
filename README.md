...
<p align="center"><img src="https://github.com/yasufuku1/Hanachan/blob/Update_layouts/app/assets/images/sample-demo1.png" alt="Hanachan_top" width="70%" height="70%" ></p>

## サイト概要

ユーザが部屋に飾った花の写真を見たり、投稿したりすることができるSNSサイトになります。

<p align="center"><img src="https://github.com/yasufuku1/Hanachan/blob/Update_layouts/app/assets/images/sample-demo2.png" alt="Hanachan_posts_index" width="70%" height="70%" ></p>
...
コロナの影響によりイベントの延期、商業施設の閉店により、生花の需要が低迷していることが問題となっています。
...
そこで花を飾る機会が少ない人でもおしゃれに飾るテクニックの参考として様々なユーザが花を飾っている写真が掲載されているサイトがあれば、アイディアのヒントになり、より一層、花のある暮らしを楽しめられると考えました。

毎日の生活が華やかになれることを願ってこのサイトを作ろうと思います。

サイト名は親しみやすさを加え「Hanachan」とちょっと可愛らしい名前にしてみました。
...
- 投稿された記事に対し、いいねやコメントでリアクションを送りたい時
